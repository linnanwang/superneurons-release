...
int main(int argc, char **argv) {
    ...
    train_image_bin = (char *) "/data/lwang/imgnet/fucking_debug/val_data_0.bin";
    train_label_bin = (char *) "/data/lwang/imgnet/fucking_debug/val_label_0.bin";
    test_image_bin  = (char *) "/data/lwang/imgnet/fucking_debug/val_data_0.bin";
    test_label_bin  = (char *) "/data/lwang/imgnet/fucking_debug/val_label_0.bin";
...
//    install_signal_processor(saver);
    ...
    base_layer_t<float>* conv_1 = (base_layer_t<float>*) new conv_layer_t<float>(1, 11, 4, 0, 0, new constant_initializer_t<float>(0.01), true, new constant_initializer_t<float>(0.0));
    ...
    base_layer_t<float>* conv_2 = (base_layer_t<float>*) new conv_layer_t<float>(1, 5, 1, 2, 2, new constant_initializer_t<float>(0.01), true, new constant_initializer_t<float>(0.1));
    ...
    base_layer_t<float>* conv_3 = (base_layer_t<float>*) new conv_layer_t<float>(1, 3, 1, 1, 1,new constant_initializer_t<float>(0.01), true, new constant_initializer_t<float>(0.0));
    base_layer_t<float>* relu_3 = (base_layer_t<float>*) new act_layer_t<float>(CUDNN_ACTIVATION_RELU, CUDNN_NOT_PROPAGATE_NAN);

    base_layer_t<float>* conv_4 = (base_layer_t<float>*) new conv_layer_t<float>(1, 3, 1, 1, 1, new constant_initializer_t<float>(0.01), true, new constant_initializer_t<float>(0.1));
    base_layer_t<float>* relu_4 = (base_layer_t<float>*) new act_layer_t<float>(CUDNN_ACTIVATION_RELU, CUDNN_NOT_PROPAGATE_NAN);

    base_layer_t<float>* conv_5 = (base_layer_t<float>*) new conv_layer_t<float>(1, 3, 1, 1, 1, new constant_initializer_t<float>(0.01), true, new constant_initializer_t<float>(0.1));
    ...
    base_layer_t<float>* full_conn_1 = (base_layer_t<float>*) new fully_connected_layer_t<float> (200,new constant_initializer_t<float>(0.005), true,
    ...
    base_layer_t<float>* drop_1      = (base_layer_t<float>*) new dropout_layer_t<float>(0.00000001);

    base_layer_t<float>* full_conn_2 = (base_layer_t<float>*) new fully_connected_layer_t<float> (200, new constant_initializer_t<float>(0.005), true,
                                                                                                       new constant_initializer_t<float>(0.1));
    base_layer_t<float>* relu_7      = (base_layer_t<float>*) new act_layer_t<float>(CUDNN_ACTIVATION_RELU, CUDNN_NOT_PROPAGATE_NAN);
    base_layer_t<float>* drop_2      = (base_layer_t<float>*) new dropout_layer_t<float>(0.00000001);

    base_layer_t<float>* full_conn_3 = (base_layer_t<float>*) new fully_connected_layer_t<float> (1000, new constant_initializer_t<float>(0.01), true,
