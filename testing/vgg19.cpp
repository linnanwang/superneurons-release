...
//    test_image_bin  = (char *) "/storage/dataset/imagenet2012/bin_file/test_data_0.bin";
//    test_label_bin  = (char *) "/storage/dataset/imagenet2012/bin_file/test_label_0.bin";
    ...
    parallel_reader_t<float> reader2(test_image_bin, test_label_bin, 2, batch_size, processor, 4, 2);
    base_layer_t<float> *data_2 = (base_layer_t<float> *) new data_layer_t<float>(DATA_TEST, &reader2);

    parallel_reader_t<float> reader1(train_image_bin, train_label_bin, 2, batch_size, processor, 4, 2);
    ...
    base_layer_t<float> *act3_3 = (base_layer_t<float> *) new act_layer_t<float>(CUDNN_ACTIVATION_RELU,
                                                                                 CUDNN_NOT_PROPAGATE_NAN);
    base_layer_t<float> *conv3_4 = (base_layer_t<float> *) new conv_layer_t<float>(256, 3, 1, 1, 1, new xavier_initializer_t<float>(),
                                                                                   true);
    base_layer_t<float> *act3_4 = (base_layer_t<float> *) new act_layer_t<float>(CUDNN_ACTIVATION_RELU,
                                                                                 CUDNN_NOT_PROPAGATE_NAN);
    ...
    base_layer_t<float> *act4_3 = (base_layer_t<float> *) new act_layer_t<float>(CUDNN_ACTIVATION_RELU,
                                                                                 CUDNN_NOT_PROPAGATE_NAN);
    base_layer_t<float> *conv4_4 = (base_layer_t<float> *) new conv_layer_t<float>(512, 3, 1, 1, 1, new xavier_initializer_t<float>(),
                                                                                   true);
    base_layer_t<float> *act4_4 = (base_layer_t<float> *) new act_layer_t<float>(CUDNN_ACTIVATION_RELU,
                                                                                 CUDNN_NOT_PROPAGATE_NAN);
    ...
    base_layer_t<float> *act5_3 = (base_layer_t<float> *) new act_layer_t<float>(CUDNN_ACTIVATION_RELU,
                                                                                 CUDNN_NOT_PROPAGATE_NAN);
    base_layer_t<float> *conv5_4 = (base_layer_t<float> *) new conv_layer_t<float>(512, 3, 1, 1, 1, new xavier_initializer_t<float>(),
                                                                                   true);
    base_layer_t<float> *act5_4 = (base_layer_t<float> *) new act_layer_t<float>(CUDNN_ACTIVATION_RELU,
                                                                                 CUDNN_NOT_PROPAGATE_NAN);
